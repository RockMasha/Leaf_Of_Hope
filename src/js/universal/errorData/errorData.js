export const errorData = {
  "Email or password are invalid": {
    ua: `Електронна пошта або пароль недійсні`,
    en: `Email or password are invalid`,
  },
  '"username" length must be less than or equal to 28 characters long': {
  ...
  '"email" fails to match the required pattern': {
    ua: `Домен почти неправельний`,
    en: `The mail domain is incorrect`,
  },
  '"phone" fails to match the required pattern': {
    ua: `Неправильно введений телефон`,
    en: `Incorrectly entered phone number`,
  },
  "Email already exists": {
    ua: `Електронна почта вже зайнята`,
    en: `Email is already busy`,
  },
  '"description" length must be less than or equal to 1000 characters long': {
    ua: `Довжина опису не повинна перевищувати 1000 символів`,
    en: `Description length must be less than or equal to 1000 characters long`,
  },
