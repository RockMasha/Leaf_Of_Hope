import { getDataOriginEnglishValue } from "../cardData/getDataOriginEnglishValue";
import { getCardPicture } from "./getCardPicture";

export function getCardInnerOriginEnglish(info) {
  const data = getDataOriginEnglishValue(info);
