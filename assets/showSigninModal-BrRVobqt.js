var he=Object.defineProperty;var F=s=>{throw TypeError(s)};var me=(s,e,t)=>e in s?he(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var j=(s,e,t)=>me(s,typeof e!="symbol"?e+"":e,t),C=(s,e,t)=>e.has(s)||F("Cannot "+t);var l=(s,e,t)=>(C(s,e,"read from private field"),t?t.call(s):e.get(s)),c=(s,e,t)=>e.has(s)?F("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(s):e.set(s,t),d=(s,e,t,a)=>(C(s,e,"write to private field"),a?a.call(s,t):e.set(s,t),t),n=(s,e,t)=>(C(s,e,"access private method"),t);import{s as v,r as _,c as ge,g as ve}from"./getErrorText-DnZHavDm.js";import{b as _e,e as pe,l as fe,f as be,h as G,i as ye,j as Se,k as we,s as Ee,m as Le,n as R,o as ke}from"./api-u4HwxF-3.js";import{c as xe}from"./chanhePage-Be1AtWlB.js";import{g as Me,d as Ce,C as $e,c as U}from"./createFormObj-ZoEntGx_.js";import{t as qe,s as Ae}from"./setSwitchLanguage-P2qgFyQt.js";import{c as Pe}from"./changeSettingsValue-79FUIYGn.js";import{g as B}from"./getCurrentLanguage-Ds8QeYUW.js";import{c as $}from"./createToken-BZOvQMhD.js";async function Te(){const s=_e();if(!s)return!1;try{return await pe(s)}catch{return!1}}const m={mainEl:document.querySelector("main"),modalEl:document.querySelector(".modal-wrapper"),form:document.querySelector(".signin-modal-form"),googleBtn:document.querySelector(".signin-modal-goggle "),errorText:document.querySelector(".signin-modal__error")};function De(){localStorage.removeItem("token")}async function H(s){s.target.removeEventListener("click",H),v();try{await fe(),De(),xe("index.html")}catch(e){console.log(e)}finally{_()}}const q={userInfo:document.querySelector("#user-info-js"),userCards:document.querySelector("#user-cards-js"),profileAdverts:document.querySelector(".profile-adverts"),advertsTitle:document.querySelector(".profile-adverts__title"),activeInput:document.querySelector(".profile-adverts-state__input")};function Ie(s){q.userInfo.innerHTML=Oe(s),Be()}function Oe(s){const{avatar:e,username:t,adress:a,phone:r,email:u,role:L}=s;return`
    ...
    </div>`}function Be(){document.querySelector(".user-info__logout").addEventListener("click",H)}function Fe(s){const e=s["small-250px"];s["medium-300px"];const t=s["big-400px"],a=e?"big-photo":"";return`
  ...
  `,setTimeout(()=>{},1500)}n(this,i,de).call(this)},D=function(e){const t=n(this,i,O).call(this,e);this.chatEl.insertAdjacentHTML("beforeend",t)},ae=function(){document.body.setAttribute("lock","");let e=document.querySelector(".delete-modal-wrapper");if(e){e.classList.remove("is-hidden");return}e=Ke(),document.body.insertAdjacentHTML("afterbegin",e),B()==="en"&&translateAllPage(settings,"en")},I=function(){n(this,i,oe).call(this),document.querySelector(".delete-modal-wrapper").classList.add("is-hidden"),document.body.removeAttribute("lock","")},ne=function(e){d(this,y,n(this,i,I).bind(this,e)),d(this,S,n(this,i,ie).bind(this,e));const t=document.querySelector(".delete-modal__btn_disagree"),a=document.querySelector(".delete-modal__btn_agree");t.addEventListener("click",l(this,y)),a.addEventListener("click",l(this,S))},oe=function(){const e=document.querySelector(".delete-modal__btn_disagree"),t=document.querySelector(".delete-modal__btn_agree");e.removeEventListener("click",l(this,y)),t.removeEventListener("click",l(this,S))},ie=async function(){v(),n(this,i,I).call(this);try{await Le(),await this.setConversation(),this.changeStatePlusPanel(),_()}catch(e){console.log(e)}},O=function(e){const{role:t,content:a}=e,r=t==="user"?this.userAvatar:this.assistAvatar;return`
          <li class="ai-assist-chat__message ai-assist-chat__message_${t}">
            ${Je(r)}
            <p class="ai-assist-chat__text">${a}</p>
          </li>`},re=function(){return new FormData(this.chatForm).get("message")},le=function(){this.chatForm.reset()},ce=function(){this.loader.classList.remove("is-hidden")},de=function(){this.loader.classList.add("is-hidden")};function Je(s){const e=s["small-chat-avatar-45px"],t=s["small-chat-avatar-45px"],a=s["chat-avatar-75px"];return`
...
</div>`}const Qe={aiAssist:document.querySelector(".ai-assist"),panelEnter:document.querySelector(".ai-assist-panel__enter"),panelText:document.querySelector(".ai-assist-panel__text"),chat:document.querySelector(".ai-assist-chat")};function Xe(s){new Ve(Qe.aiAssist,s.user.avatar).setCommunication()}function ue(s){document.querySelector(".ai-assist")&&Xe(s)}const Ze=void 0;function et(s){const e=document.createElement("script");e.src="https://accounts.google.com/gsi/client",e.async=!0,e.defer=!0,e.onload=s,document.head.appendChild(e)}function tt(){et(()=>{google.accounts.id.initialize({client_id:Ze,callback:st})})}async function st(s){v();const{credential:e}=s;try{const t=await R({token_id:e}),{token:a}=t;$(a),ue(t),await P()}catch{try{const a=await ke(e),{token:r}=a;$(r),await P()}catch{}}finally{_()}}async function at(s){s.preventDefault();const e=U(m.form);await nt(e)}async function nt(s){v();try{const e=await R(s);$(e.token),ue(e),await P()}catch(e){return console.log(e),ot(e),!1}finally{_()}}function ot(s){var r,u;const e=(u=(r=s==null?void 0:s.response)==null?void 0:r.data)==null?void 0:u.message,a=ve(e,{property:"singinError",settings:z});m.errorText.textContent=a}function vt(){m.mainEl.classList.add("is-hidden"),m.modalEl.classList.remove("is-hidden"),document.body.setAttribute("lock",""),m.modalEl.addEventListener("submit",at),tt(),m.googleBtn.addEventListener("click",()=>{google.accounts.id.prompt()})}export{vt as a,M as b,z as c,Xe as d,Te as i,We as p,Ye as s};
