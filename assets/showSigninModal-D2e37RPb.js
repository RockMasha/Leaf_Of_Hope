var G=(s,e,t)=>{if(!e.has(s))throw TypeError("Cannot "+t)};var o=(s,e,t)=>(G(s,e,"read from private field"),t?t.call(s):e.get(s)),r=(s,e,t)=>{if(e.has(s))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(s):e.set(s,t)},l=(s,e,t,a)=>(G(s,e,"write to private field"),a?a.call(s,t):e.set(s,t),t);var n=(s,e,t)=>(G(s,e,"access private method"),t);import{b as fe,e as ye,l as be,f as Se,h as we,i as Ee,j as xe,s as Ce,k as Le,m as Me}from"./api-BuuO_-Fj.js";import{s as z,r as W,c as ke,g as $e}from"./getErrorText-BIic-AA2.js";import{g as qe,d as Pe,C as Ae,c as Te}from"./createFormObj-BzHA-4oM.js";import{t as De,s as Be}from"./setSwitchLanguage-Db4k4_JV.js";import{g as N}from"./setCurrentLanguage-BcqUJ1w1.js";async function Ie(){const s=fe();if(!s)return!1;try{return await ye(s)}catch{return!1}}const Oe=document.querySelector(".modal-wrapper"),E={modalEl:document.querySelector(".modal-wrapper"),form:document.querySelector(".signin-modal-form"),errorText:document.querySelector(".signin-modal__error")},x={userInfo:document.querySelector("#user-info-js"),userCards:document.querySelector("#user-cards-js"),profileAdverts:document.querySelector(".profile-adverts"),advertsTitle:document.querySelector(".profile-adverts__title")};function je(){localStorage.removeItem("token")}async function Z(s){s.target.removeEventListener("click",Z),z();try{await be(),je(),window.location.href="index.html"}catch(e){console.log(e)}finally{W()}}function Fe(s){x.userInfo.innerHTML=Ue(s),He()}function Ue(s){const{avatar:e,username:t,adress:a,phone:i,email:d}=s;return`
    ...
    </div>`}function He(){document.querySelector(".user-info__logout").addEventListener("click",Z)}function ze(s){const e=s["small-250px"];s["medium-300px"];const t=s["big-400px"],a=e?"big-photo":"";return`
...
</div>`}const tt={aiAssist:document.querySelector(".ai-assist"),panelEnter:document.querySelector(".ai-assist-panel__enter"),panelText:document.querySelector(".ai-assist-panel__text"),chat:document.querySelector(".ai-assist-chat")};function st(s){new Xe(tt.aiAssist,s.user.avatar).setCommunication()}async function at(s){s.preventDefault(),z();const e=Te(E.form);try{const t=await Me(e);ke(t.token),nt(t),await Qe()}catch(t){rt(t)}finally{W()}}function rt(s){var i,d;const e=(d=(i=s==null?void 0:s.response)==null?void 0:i.data)==null?void 0:d.message,a=$e(e,{property:"singinError",settings:ee});E.errorText.textContent=a}function nt(s){document.querySelector(".ai-assist")&&st(s)}function ht(){E.modalEl.classList.remove("is-hidden"),document.body.setAttribute("lock",""),E.modalEl.addEventListener("submit",at)}export{ht as a,X as b,ee as c,tt as d,st as e,Ie as i,Je as p,x as r,Ke as s};
