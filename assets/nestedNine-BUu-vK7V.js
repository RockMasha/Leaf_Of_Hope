import{h as r}from"./getCurrentLanguage-BQe-LnNi.js";import{c as a}from"./createToken-Br3huXJa.js";import{c as s}from"./chanhePage-Be1AtWlB.js";import{q as c}from"./api-g_UhaQ4A.js";import{g as n}from"./getValueSrcParams-BMgebK2A.js";import{s as i}from"./setSwitchLanguage-C96-qGVS.js";import"./setCurrentLanguage-DbURY5zX.js";async function u(){let e;try{const t=n("verification");e=await c(t)}catch(t){return console.log(t),!1}return e.token}const o={authenticationCont:document.querySelector(".authentication__container")};function m(){o.authenticationCont.innerHTML=`
    <img
