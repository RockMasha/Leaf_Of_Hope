...
</div>`}const tt={aiAssist:document.querySelector(".ai-assist"),panelEnter:document.querySelector(".ai-assist-panel__enter"),panelText:document.querySelector(".ai-assist-panel__text"),chat:document.querySelector(".ai-assist-chat")};function st(s){new Xe(tt.aiAssist,s.user.avatar).setCommunication()}async function at(s){s.preventDefault(),W();const e=Te(E.form);try{const t=await Me(e);ke(t.token),nt(t),await Qe()}catch(t){rt(t)}finally{z()}}function rt(s){var i,d;const e=(d=(i=s==null?void 0:s.response)==null?void 0:i.data)==null?void 0:d.message,a=$e(e,{property:"singinError",settings:ee});E.errorText.textContent=a}function nt(s){document.querySelector(".ai-assist")&&st(s)}function ht(){E.modalEl.classList.remove("is-hidden"),document.body.setAttribute("lock",""),E.modalEl.addEventListener("submit",at)}export{ht as a,X as b,ee as c,st as d,Ie as i,Je as p,tt as r,Ke as s};
