var A=(s,t,i)=>{if(!t.has(s))throw TypeError("Cannot "+i)};var n=(s,t,i)=>(A(s,t,"read from private field"),i?i.call(s):t.get(s)),a=(s,t,i)=>{if(t.has(s))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(s):t.set(s,i)},h=(s,t,i,e)=>(A(s,t,"write to private field"),e?e.call(s,i):t.set(s,i),i);var r=(s,t,i)=>(A(s,t,"access private method"),i);import{c}from"./cardData-DyQ4QymL.js";function Z(s){const{alergenicity:t,humidity:i,image:e,lifeDuration:o,light:_,name:U,size:V,temperature:W,way:X,_id:Y}=s;return` <a href="advert.html?id=${Y}" class="card">
