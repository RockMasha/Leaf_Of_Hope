import{h as d}from"./setCurrentLanguage-DdORZCPD.js";import{g as p}from"./getValueSrcParams-BMgebK2A.js";import{r as f,d as h,e as g}from"./api-B7v0WwrB.js";import{c as _,s as b}from"./showPhoto-BRLbcwku.js";import{s as y,r as w,g as v,e as x}from"./getErrorText-5M_7QVY4.js";import{c}from"./changeSettingsValue-79FUIYGn.js";import{s as S}from"./setSwitchLanguage-CyEaCAgr.js";function m(){return!!p("redact")}const a={form:document.querySelector(".change-profile-form"),title:document.querySelector(".change-profile__title"),photo:document.querySelector(".change-profile-form__img"),svgWrapp:document.querySelector(".change-profile-form__svg-wpapp"),password:document.querySelector(".change-profile-form__enter_password"),email:document.querySelector(".change-profile-form__enter_email"),btnSubmit:document.querySelector(".change-profile-form__btn-submit"),error:document.querySelector(".change-profile__error")};function T(){document.body.setAttribute("lock",""),document.body.insertAdjacentHTML("afterbegin",`
