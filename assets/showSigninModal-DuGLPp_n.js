      ...
      <div class="user-info__text-block">
        <div class="user-info__user">
          ...
          <div class="user-info__btn-box">
            ...
            ${L==="admin"?`<button class="user-info__btn user-info__metabase">
