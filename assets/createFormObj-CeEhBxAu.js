var N=(a,t,s)=>{if(!t.has(a))throw TypeError("Cannot "+s)};var n=(a,t,s)=>(N(a,t,"read from private field"),s?s.call(a):t.get(a)),i=(a,t,s)=>{if(t.has(a))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(a):t.set(a,s)},d=(a,t,s,e)=>(N(a,t,"write to private field"),e?e.call(a,s):t.set(a,s),s);var r=(a,t,s)=>(N(a,t,"access private method"),s);import{c as D}from"./cardData-CVkVixM2.js";import{g as dt}from"./getDataValue-07PZ5mIk.js";import{a as ct,g as lt}from"./setCurrentLanguage-DdORZCPD.js";const xt={defaultCardListText:{ua:"Немає оголошень",en:"There are no adverts"}};function ht(a){const t=a["very-small-175px"],s=a["medium-300px"];return`
