import{h as p}from"./getCurrentLanguage-DUgTUic5.js";import{g as d}from"./getValueSrcParams-BMgebK2A.js";import{r as f,d as h,e as g}from"./api-C319RYlQ.js";import{s as _,c as b,r as y,g as w,e as v}from"./getErrorText-D4hBfj7B.js";import{s as x}from"./showPhoto-C-J7rVy8.js";import{c}from"./changeSettingsValue-79FUIYGn.js";import{s as S}from"./setSwitchLanguage-C5O04CdM.js";import"./setCurrentLanguage-BJ078Sy1.js";function m(){return!!d("redact")}const a={form:document.querySelector(".change-profile-form"),title:document.querySelector(".change-profile__title"),photo:document.querySelector(".change-profile-form__img"),svgWrapp:document.querySelector(".change-profile-form__svg-wpapp"),password:document.querySelector(".change-profile-form__enter_password"),email:document.querySelector(".change-profile-form__enter_email"),btnSubmit:document.querySelector(".change-profile-form__btn-submit"),error:document.querySelector(".change-profile__error")};function T(){document.body.setAttribute("lock",""),document.body.insertAdjacentHTML("afterbegin",`
  ...
  `)}async function i(e){e.preventDefault(),P(),_();try{const t=b(a.form);m()?(await f(t),window.location.href="profile.html"):(await h(t),T())}catch(t){E(t),L(),console.log(t)}finally{y()}}function E(e){var o,n;const t=(n=(o=e==null?void 0:e.response)==null?void 0:o.data)==null?void 0:n.message,r=w(t);a.error.textContent=r}function P(){a.form.addEventListener("submit",u),a.form.removeEventListener("submit",i)}function L(){a.form.removeEventListener("submit",u),a.form.addEventListener("submit",i)}function u(e){e.preventDefault()}const s={mainTitle:{ua:"Редагування",en:"Editing"},nameText:{ua:"Ім'я",en:"Name"},namePlaceholder:{placeholder:!0,ua:"Введіть ім'я",en:"Enter a name"},locationText:{ua:"Місце проживання",en:"Place of residence"},locationPlaceholder:{placeholder:!0,ua:"Ведіть місце проживання",en:"Enter your place of residence"},phoneText:{ua:"Телефон",en:"Phone"},phonePlaceholder:{placeholder:!0,ua:"Починайте з коду країни",en:"Start with the country code"},passwordText:{ua:"Пароль",en:"Password"},passwordPlaceholder:{placeholder:!0,ua:"Введіть пароль",en:"Enter your password"},emailText:{ua:"Пошта",en:"Email"},emailPlaceholder:{placeholder:!0,ua:"Введіть ваш емейл",en:"Enter your email"},submitText:{ua:"Зберегти",en:"Save"}};Object.assign(s,v);function q(){a.password.innerHTML=`
    ...
    <picture class="form-advert__svg big-photo">
      ...
      <img
        ...
        loading="lazy"
      />
    </picture>`}a.photo.onchange=x.bind(void 0,a.photo);m()?await $():q();a.form.addEventListener("submit",i);S(s);p();
