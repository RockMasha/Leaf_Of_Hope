import{h as u}from"./hiddenContentLoader-M9V2kOsv.js";import{g as l}from"./getValueSrcParams-BMgebK2A.js";import{r as p,h as f,d}from"./api-C87ePszt.js";import{s as g,c as h,r as _}from"./setInProgressLoader-DtNgW6Wc.js";import{c as b,s as v}from"./showPhoto-BLcMjZRy.js";function m(){return!!l("redact")}const e={form:document.querySelector(".change-profile-form"),title:document.querySelector(".change-profile__title"),photo:document.querySelector(".change-profile-form__img"),svgWrapp:document.querySelector(".change-profile-form__svg-wpapp"),password:document.querySelector(".change-profile-form__enter_password"),email:document.querySelector(".change-profile-form__enter_email"),btnSubmit:document.querySelector(".change-profile-form__btn-submit"),error:document.querySelector(".change-profile__error")};async function a(r){r.preventDefault(),w(),g();try{const t=b(e.form);if(m())await p(t);else{const o=await f(t);h(o.token)}window.location.href="profile.html"}catch{e.error.textContent="Неравельно ввід або такий юзер вже є",y()}finally{_()}}function w(){e.form.addEventListener("submit",c),e.form.removeEventListener("submit",a)}function y(){e.form.removeEventListener("submit",c),e.form.addEventListener("submit",a)}function c(r){r.preventDefault()}function S(){e.password.innerHTML=`
              Пароль
              <input
